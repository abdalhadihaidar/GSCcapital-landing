    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight" dir={isRTL ? 'rtl' : 'ltr'}>
          ...
          <p className="text-lg sm:text-xl text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in" dir={isRTL ? 'rtl' : 'ltr'}>
            {t.hero.description}
          </p>
